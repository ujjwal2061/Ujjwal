    ...
    return(
        ...
        <div className="   p-2 grid  grid-cols-3  md:grid-cols-4 justify-center gap-1 mt-1">
             {SkillList.map((skill,index)=>(
                <li key={index} 
                className="bg-zinc-900  bg-opacity-75 border-[0.9px] border-zinc-700 flex justify-center items-center text-white w-full sm:w-auto md:w-18 py-2 shadow-md px-3 font-semibold rounded-md text-center text-xs md:text-sm">
